...
Route::get('/gempa', [BmkgController::class, 'gempa'])->middleware('auth');
Route::get('/cuaca', [BmkgController::class, 'cuaca'])->middleware('auth');
...
Route::get('/transaksi_harian', [TransaksiHarianController::class, 'index'])->name('transaksi_harian.index');
